...
Os scripts usam `datasets-raw/libras-alphabet/` na raiz do repositório. Os intermediários ficam em `training-output/` (ignorado pelo Git), e o export grava em `client/public/models/gesture-classifier/`.
